...
function renderTopbar(active = "admin", showAdminTabs = false) {
  return `
    <header class="topbar">
      ...
      <span class="build-badge no-print">Build 20260722 Subject Lock Upgrade</span>
      ...
      <main class="locked login-stage">
        <section class="login-showcase admin-showcase">
          ...
          <div class="panel login-panel login-card stack">
            ...
            <button class="primary login-primary" onclick="verifyAdminLogin()">Enter Admin Dashboard</button>
    ...
    <section class="grid two">
      <div class="panel stack">
        ...
        <div class="card stack">
          ...
          <p class="hint">Use this once in a while as a backup. The file opens in Excel and keeps passage text, answers, and explanations.</p>
        </div>
      </div>
      <div class="panel stack">
        <div class="section-head">
...
async function startStudentExam() {
  ...
  try {
    ...
    await beginStudentExam(examResponse, name, studentId);
  } catch (error) {
    alert(error.message);
  }
}
...
async function chooseCombinedExam(examId) {
  ...
  try {
    ...
    await beginStudentExam(exam, activeExamBundle.studentName, activeExamBundle.studentId);
  } catch (error) {
    alert(error.message);
  }
}

async function beginStudentExam(exam, name, studentId) {
  activeExam = exam;
  activeExamBundle = null;
  activeStudent = name;
