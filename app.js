  ...
  $("#app").innerHTML = `
    <div class="student-exam-shell">
      <header class="student-exam-topbar">
        <div class="student-exam-brand" aria-label="Topway Prep"><img class="student-exam-logo" src="/assets/topway-prep-logo-transparent.png?v=20260805" alt="Topway Prep" onerror="this.onerror=null;this.src='/assets/topway-prep-logo.png?v=20260805';" /></div>
...
function getBankQuestionReadinessIssues(question) {
  if (String(question?.qualityApprovedAt || "").trim()) return [];
  const issues = [];
  const type = normalizeQuestionType(question.type);
    ...
    <div class="student-exam-shell">
      <header class="student-exam-topbar">
        <div class="student-exam-brand" aria-label="Topway Prep">
          <img class="student-exam-logo" src="/assets/topway-prep-logo-transparent.png?v=20260805" alt="Topway Prep" onerror="this.onerror=null;this.src='/assets/topway-prep-logo.png?v=20260805';" />
        </div>
