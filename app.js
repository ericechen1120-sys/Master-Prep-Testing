  ...
  return `
    <div class="stack build-workflow-grid">
      ...
      <div class="card stack question-mix-builder">
        <div class="section-head"><div><h3>Step 2 — Flexible Question Mix</h3><p class="subtle">Choose any difficulty levels, an exact reading-comprehension count, and only the answer formats you want.</p></div><span class="pill warn">Review draft</span></div>
...
function getQuestionMixRequest() {
  ...
  return { target, requested, optionalTotal, readingTarget, readingPercent, difficultyLevels, avoidUsed, reusePolicy, program, targetStudentId };
}
...
function buildQuestionMixDraft() {
  const { target, requested, optionalTotal, readingTarget, readingPercent, difficultyLevels, avoidUsed, reusePolicy, program, targetStudentId } = getQuestionMixRequest();
  ...
  if (configurationErrors.length) {
    return { target, requested, selected: [], shortfalls: [], configurationErrors, difficultyLevels, readingTarget, readingPercent, readingCount: 0, difficultyCounts: {}, passageSetCount: 0, poolCount: 0, avoidUsed, reusePolicy, program, targetStudentId, complete: false };
  }
