  ...
  $("#app").innerHTML = `
    <div class="student-exam-shell">
      <header class="student-exam-topbar">
        <div class="student-exam-brand" aria-label="Topway Prep"><img class="student-exam-logo" src="/assets/topway-prep-logo-transparent.png?v=20260805" alt="Topway Prep" onerror="this.hidden=true;" /></div>
    ...
    <div class="student-exam-shell">
      <header class="student-exam-topbar">
        <div class="student-exam-brand" aria-label="Topway Prep">
          <img class="student-exam-logo" src="/assets/topway-prep-logo-transparent.png?v=20260805" alt="Topway Prep" onerror="this.hidden=true;" />
        </div>
