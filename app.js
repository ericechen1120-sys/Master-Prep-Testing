...
function renderTopbar(active = "admin", showAdminTabs = false) {
  return `
    <header class="topbar">
      ...
      <span class="build-badge no-print">Build 20260722 Bank Excel Backup Upgrade</span>
      ...
      <div class="panel stack">
        ...
        <div class="card stack">
          ...
          <div class="grid two compact-grid">
            ...
            <div class="field"><label>Answer type</label><select id="singleBankType"><option value="multiple">Multiple choice</option><option value="numeric">Grid-in / Numeric</option></select></div>
          </div>
      ...
      <div class="grid two compact-grid">
        <div class="field">
          ...
          <select id="batchBankType">
            ...
            <option value="numeric">Grid-in / Numeric</option>
          </select>
        </div>
      ...
      <div class="grid two">
        ...
        <div class="stack">
          <div class="grid two compact-grid">
            ...
            <div class="field"><label>Answer type</label><select data-bank-q="${question.id}" data-field="type"><option value="multiple" ${question.type !== "numeric" ? "selected" : ""}>Multiple choice</option><option value="numeric" ${question.type === "numeric" ? "selected" : ""}>Grid-in / Numeric</option></select></div>
...
function renderQuestionLivePreview(question) {
  ...
  return `
    ...
    <article class="question preview-question" data-section="${escapeHtml(draft.section)}" data-original-number="${draft.originalNumber || draft.number}">
      ...
      ${
        draft.type === "numeric"
          ? `<input placeholder="Student numeric answer" disabled />`
...
function analyzeQuestionCsv(text) {
  ...
  rows.slice(1).forEach((row, index) => {
    ...
    const isGrid = /grid|numeric|free/.test(type) || correctLetter.toUpperCase() === "GRID-IN";
