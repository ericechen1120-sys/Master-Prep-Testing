  ...
  return `
    <section class="panel stack general-report">
      ...
      ${
        analysis.weakAreas.length
          ? `<div class="notice">
              Teaching focus: start with ${escapeHtml(analysis.weakAreas
                .slice(0, 3)
                .map((area) => area.label)
                .join(", "))}. These are the highest-frequency misses in the current report set.
            </div>`
          : ""
      }
    </section>
...
function buildGeneralReport(submissions) {
  ...
  return { count, average, high, low, weakestArea: weakAreas[0] || null, weakAreas, hardQuestions };
}
  ...
  return `
    <section class="panel stack specific-student-report">
      ...
      ${
        analysis.weakAreas.length
          ? `<div class="notice">
              Student plan: review ${escapeHtml(analysis.weakAreas
                .slice(0, 2)
                .map((area) => area.label)
                .join(" and "))}, then assign a short retake using the missed-question topics.
            </div>`
          : ""
      }
    </section>
