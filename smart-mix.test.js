...
const fields = {
  ...
  '#aiExamReadingPercent': { value: '50' },
  '#aiExamTargetStudentId': { value: '' },
};
...
fields['#aiExamQuestionCount'].value = '50';
fields['#aiExamReadingPercent'].value = '80';
updateSmartReadingFromPercent();
assert.equal(fields['#aiExamReadingCount'].value, '40');
fields['#aiExamReadingCount'].value = '10';
updateSmartReadingPercentFromCount();
assert.equal(fields['#aiExamReadingPercent'].value, '20');
`;
